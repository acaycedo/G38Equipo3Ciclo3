								...
								<div class="col-xl-12">
									<div class="card mb-4">
										<div class="card-header text-white bg-dark">
											<i class="fas fa-table"></i> Eliminar datos de proveedores
										</div>
										<div class="card-body">
											<div class="container">
												<div id="error" class="alert alert-danger visually-hidden"
													role="alert">Error al eliminar el proveedor o no exite.</div>

												<div id="correcto"
													class="alert alert-success visually-hidden" role="alert">Eliminado con exito.</div>
												...
												<button type="button" class="btn btn-danger"
													onclick="eliminar()">
													<i class="fas fa-check"></i> Eliminar Datos
												</button>
