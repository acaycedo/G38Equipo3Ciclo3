										...
										<div class="card-body">
											<div class="container">
												<div id="error" class="alert alert-danger visually-hidden"
													role="alert">Error al consultar cliente o cliente no existe</div>

												<div id="correcto"
													class="alert alert-success visually-hidden" role="alert">Cliente encontrado con exito</div>
												...
												<form id="form1">
													...
													<div class="input-group mb-3">
														...
														<input type="text" class="form-control"
															...
															id="nombre_cliente" disabled="disabled">
													</div>
