...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      <h3 class="float-md-start mb-0">Tiendas Genericas</h3>
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link active" aria-current="page" href="indexes.html">Inicio</a>
        <a class="nav-link" href="loginclient.jsp">Iniciar Sesión</a>
		...
		<div class="row">
			<div class="col-8" style="padding:25px">
				...
				<div class="input-container">
					<label for="inputuser">Usuario</label> <br>
           <input type="text" id="inputuser" name="email">
         </div>
         <div class="input-container">
